...
hi!     Constant                ctermfg = 209                  guifg = #FF7AB2
hi!       Cursor ctermbg = NONE ctermfg = NONE guibg = NONE    guifg = NONE
hi! CursorLineNr ctermbg = NONE ctermfg = 251  guibg = NONE    guifg = #fafbfc
...
hi!    Directory                ctermfg = 203                  guifg = #FF7AB2
hi!        Error ctermbg = 233  ctermfg = 203  guibg = NONE    guifg = #FF7AB2
hi!     ErrorMsg ctermbg = 233  ctermfg = 203  guibg = NONE    guifg = #FF7AB2
hi!   WarningMsg ctermbg = 233  ctermfg = 203  guibg = NONE    guifg = #FF7AB2
hi!  EndOfBuffer ctermbg = 233  ctermfg = 236  guibg = NONE    guifg = NONE
hi!   SpecialKey ctermbg = 203  ctermfg = 235  guibg = #eC6a88 guifg = NONE
...
hi!       LineNr ctermbg = NONE ctermfg = 239  guibg = NONE    guifg = #5c5c5c
hi!   MatchParen ctermbg = 237  ctermfg = 255  guibg = #444444 guifg = #ffffff
hi!      MoreMsg                ctermfg = 48                   guifg = #96ffb1
hi!       Normal ctermbg = NONE ctermfg = 252  guibg = NONE    guifg = #e6e6e6
...
hi!      Special                ctermfg = 203                                    guifg = #FF7AB2
...
hi!   SpellLocal ctermbg = 23   ctermfg = 203                  gui   = undercurl guisp = #eC6a88
...
hi!   TabLineSel ctermbg = 234  ctermfg = 247  guibg = #eC6a88 guifg = #9a9ca5 gui = NONE
hi!        Title                ctermfg = 37                   guifg = #FF7AB2 gui = bold
hi!         Todo ctermbg = 59   ctermfg = 48   guibg = #45493e guifg = #67fccc gui = inverse,bold
hi!         Type                ctermfg = 209                  guifg = #fcb4ae gui = NONE
hi!   Underlined                ctermfg = 37                   guifg = #FF7AB2 gui = underline
hi!    VertSplit ctermbg = 233  ctermfg = 233  guibg = #000000 guifg = #000000 gui = bold
...
hi!        Sneak ctermbg = 140  ctermfg = 234  guibg = #f09483 guifg = #eC6a88
...
hi!     StatusLineNC ctermbg = 237  ctermfg = 233  guibg = #333333 guifg = #000000 gui = reverse
hi! StatusLineTermNC ctermbg = 237  ctermfg = 233  guibg = #333333 guifg = #000000 gui = reverse

hi! NERDTreeDir      ctermbg = NONE ctermfg = 252  guibg = NONE guifg = #e6e6e6
hi! NERDTreeOpenable ctermbg = NONE ctermfg = 252  guibg = NONE guifg = #e6e6e6
hi! NERDTreeFlags    ctermbg = NONE ctermfg = 37   guibg = NONE guifg = #3fb2ff
...
if has('nvim')
  ...
  let g:terminal_ansi_colors = ['#0f0f0f', '#eC6a88', '#09f7a0', '#FFD2A6', '#c4b7ff', '#f09483', '#eC6a88', '#0f0f0f', '#d5d8da', '#ec6a88', '#6bdfe6', '#fab38e', '#21bfc2', '#00bfff', '#95c4ce', '#d2d4de']
endif
