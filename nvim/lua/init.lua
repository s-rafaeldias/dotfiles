...
treesitter.setup {
    ensure_installed = { 'lua', 'javascript', 'python', 'bash', 'beancount', 'c', 'cpp', 'go', 'ruby', 'tsx', 'typescript', 'comment', 'json' };
    highlight = {
        enable = true
    }
}
...
vimp.nnoremap({'override'},'<Leader>fg', function() telescope_builtin.git_files{} end)
